 ...
 * @since       1.0
 */
class EcommApiResourceEcommGetSingleOrderDetails extends ApiResource
{
    /**
    ...
    public function post()
    {
        ...
        $shopId  = isset($inputData['shopId']) ? $inputData['shopId'] : '';
        $orderId = $inputData['orderId'];

        $data = $service->ecommGetSingleOrderDetails($shopId, $orderId);
