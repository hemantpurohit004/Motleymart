 ...
 * @since       1.0
 */
class EcommApiResourceEcommUpdatePaymentDetailsForOrder extends ApiResource
{
	/**
	...
	public function post()
	{
		...
		$data = $service->ecommUpdatePaymentDetailsForOrder($paymentMode, $orderDetails, $response);
