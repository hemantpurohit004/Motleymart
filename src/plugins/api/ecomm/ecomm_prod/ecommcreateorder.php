...
class EcommApiResourceEcommCreateOrder extends ApiResource
{
	...
	public function post()
	{
		...
		$couponDetails = $inputData['couponDetails'];

		// TODO-check the shipping workflow?
		// $shippingAddressId = $input->get('shipping','','INT');

		$shippingAddressId = 0;

		$data = $service->ecommCreateOrder($productsDetails, $shippingAddressId, $billingAddressId, $couponDetails);
