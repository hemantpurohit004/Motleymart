...
$lang->load('plg_payment_byordercard', JPATH_ADMINISTRATOR);
require_once dirname(__FILE__) . '/byordercard/helper.php';
 ...
 * @since       2.2
 */
class Plgpaymentbyordercard extends JPlugin
{
	protected  $payment_gateway = 'byordercard';
	...
	public function onTP_Storelog($data)
	{
		...
		if ($log_write == 1)
		{
			$plgPaymentByorderCardHelper = new plgPaymentByorderCardHelper;
			$log                     = $plgPaymentByorderCardHelper->Storelog($this->_name, $data);
		}
	}
}
