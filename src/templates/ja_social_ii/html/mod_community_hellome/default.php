...
<div class="joms-module--hellome">
    ...
    <div class="joms-hcard">
        ...
        <div class="joms-hcard__cover">
            ...
            <img src="<?php echo $user->getCover(); ?>" alt="<?php echo $user->name; ?>" style="width:100%;top:<?php echo $userParams->get('coverPosition', ''); ?>">
            ...
            <?php if($moduleParams->get('show_avatar') || $moduleParams->get('show_name')) { ?>
                ...
                <div class="joms-hcard__info">
                    ...
                    <div class="joms-hcard__info-content">
                        <h3 class="reset-gap"><?php echo $user->name; ?></h3>
    ...
    <?php if($moduleParams->get('show_menu')) { ?>
        <ul class="joms-list joms-list--hellome">
            <li><a href="<?php echo CRoute::_('index.php?option=com_community&view=friends'); ?>"><?php echo JText::_('MOD_HELLOME_MY_FRIENDS'); ?><span><?php echo $user->_friendcount; ?></a></span></li>
            <li><a href="<?php echo CRoute::_('index.php?option=com_community&view=photos'); ?>"><?php echo JText::_('MOD_HELLOME_MY_PHOTOS'); ?><span><?php echo $totalPhotos; ?></a></span></li>
            <li><a href="<?php echo CRoute::_('index.php?option=com_community&view=videos'); ?>"><?php echo JText::_('MOD_HELLOME_MY_VIDEOS'); ?><span><?php echo $totalVideos; ?></a></span></li>
            <li><a href="<?php echo CRoute::_('index.php?option=com_community&view=groups'); ?>"><?php echo JText::_('MOD_HELLOME_MY_GROUPS'); ?><span><?php echo $totalGroups; ?></a></span></li>
            <li><a href="<?php echo CRoute::_('index.php?option=com_community&view=events'); ?>"><?php echo JText::_('MOD_HELLOME_MY_EVENTS'); ?><span><?php echo $totalEvents; ?></a></span></li>
        </ul>
    <?php } ?>
