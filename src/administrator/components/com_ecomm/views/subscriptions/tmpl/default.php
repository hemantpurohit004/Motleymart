...
<?php
	...
	<?php endif;?>
<form action="<?php echo JRoute::_('index.php?option=com_ecomm&view=subscriptions'); ?>" method="post" name="adminForm" id="adminForm">
	<div class="row-fluid">
		<div class="span10">
		<?php
		...
		<div class="col-md-10 col-md-offset-2">
			<table class="table table-striped table-hover">
				...
				<tr>
					...
					<th width="10%" class="nowrap center">
						<?php echo JHtml::_('grid.sort', JText::_("Duration"), 'duration', $listDirn, $listOrder);?>
					</th>
					<th width="10%" class="nowrap center">
