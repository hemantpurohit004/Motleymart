 ...
 * @since  1.6
 */
class EcommViewBanners extends JViewLegacy
{
/**
	* Display the view
	*
	...
	*/
	...
	{
		JToolBarHelper::title('Banners');
		JToolBarHelper::addNew('banner.add');
		JToolBarHelper::editList('banner.edit');
		JToolBarHelper::deleteList(JText::_('Are you sure to detete this banner?'), 'banners.delete', JText::_('Delete'));
